    ...
    return(
        <div className="py-5 px-5 md:px-12 lg:px-28  ">
         ...
         <Image src={assets.logo} width={180} height={50} alt="Logo" loading="eager" className="w-[130px] sm:w-auto"/>
                <button className="flex items-center gap-2 font-medium py-1 py-3 sm:py-3 sm:px-6 border border-solid border-black border-black shadow-[-7px_7px_0px_#000000]" >Get Started</button>
            </div>
            <div className='text-center my-8'>
            <h1 className='text-3xl sm:text-5xl font-medium'>Latest Blog</h1>
            <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas quasi perspiciatis, laborum voluptate incidunt assumenda fugiat quisquam doloremque repellat quidem!</p>
